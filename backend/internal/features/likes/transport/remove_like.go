...
// @Success 201 {object} LikePostDTOResponse "Лайк убран"
...
func (h *LikesHTTPHandler) RemoveLike(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	log.Debug("unlike post request for user", zap.String("user_id", userID))
