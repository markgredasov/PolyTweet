...
type GetPostByIdDTOResponse struct {
	...
	Username   string    `json:"username" example:"m4rkek" extensions:"x-order=2"`
	Content    string    `json:"content" example:"Hello, world!" extensions:"x-order=3"`
	LikesCount int       `json:"likes_count" example:"0" extensions:"x-order=4"`
	ParentID   *string   `json:"parent_id" example:"123e4567-e89b-12d3-a456-426614174000" extensions:"x-order=5"`
	ReplyTo    *string   `json:"reply_to" example:"123e4567-e89b-12d3-a456-426614174000" extensions:"x-order=6"`
	ImageURL   string    `json:"image_url" example:"https://example.com/image.jpg" extensions:"x-order=7"`
	AvatarURL  string    `json:"avatar_url" example:"https://example.com/image.jpg" extensions:"x-order=8"`
	CreatedAt  time.Time `json:"created_at" example:"2026-03-25T12:00:41.267Z" extensions:"x-order=9"`
}
